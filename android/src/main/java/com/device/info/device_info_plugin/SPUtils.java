...
public class SPUtils {
	...
	/**
	 * 保存在手机里面的文件名 /data/data/  私有文件目录下  程序卸载会删除
	 */
	public static final String FILE_NAME = "space_config";
	...
	public static void putForDeviced(Context context, String key, Object object) {
		putForDevice(context, FILE_NAME, key, object);
	}
	...
	private static void putForDevice(Context context, String fileName, String key, Object object) {
		if(TextUtils.isEmpty(fileName)){
			fileName = FILE_NAME;
		}
		SharedPreferences sp = context.getSharedPreferences(fileName, Context.MODE_PRIVATE);
	...
	private static Object get(Context context, String fileName, String key, Object defaultObject) {
		SharedPreferences sp = context.getSharedPreferences(fileName, Context.MODE_PRIVATE);
